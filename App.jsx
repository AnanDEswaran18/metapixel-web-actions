      ...
      <div className="container">
        ...
        <div className="cards-grid">
          <div className="card">
            ...
            <p>Test standard e-commerce tracking events for online shopping flow</p>
            <div className="button-group">
              ...
              <button className="btn btn-success" onClick={handleInitiateCheckout}>
                💳 Initiate Checkout
              </button>
              <button className="btn btn-info" onClick={handlePurchase}>
                ✅ Complete Purchase
              </button>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <p>Track user registration and lead generation events</p>
            <div className="button-group">
              <button className="btn btn-warning" onClick={handleLead}>
                📝 Generate Lead
              </button>
              <button className="btn btn-success" onClick={handleCompleteRegistration}>
          ...
          <div className="card">
            ...
            <p>Monitor user engagement and interaction events</p>
            <div className="button-group">
        ...
        <div className="event-form">
          ...
          <form onSubmit={handleCustomEvent}>
